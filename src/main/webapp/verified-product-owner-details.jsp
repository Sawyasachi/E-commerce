...
<head>
<meta charset="UTF-8">
<title>Verified product owner details</title>
			...
			<table
				...
				<tbody>
					...
					<tr>
						...
						<td><span class="badge badge-success rounded-pill d-inline"><%=owner.getProductOwnerVerify()%></span></td>
						<td><a href="ownerUnVerify?id=<%=owner.getProductOwnerId()%>"
							class="btn btn-danger btn-sm">UN-VERIFY</a></td>
					</tr>
					<%
					}
					%>
